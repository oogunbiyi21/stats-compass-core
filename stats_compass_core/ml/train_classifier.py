...
class TrainClassifierInput(BaseModel):
    ...
    model_type: str = Field(
        ...
        description="Type of classifier: 'logistic_regression', 'random_forest', 'gradient_boosting'"
    )
...
def train_classifier(df: pd.DataFrame, params: TrainClassifierInput) -> TrainedClassifierResult:
    """
