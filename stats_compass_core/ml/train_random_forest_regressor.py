...
@registry.register(
    category="ml",
    input_schema=TrainRandomForestRegressorInput,
    description="Train a random forest regressor",
)
def train_random_forest_regressor(
    state: DataFrameState, params: TrainRandomForestRegressorInput
) -> ModelTrainingResult:
    """
    Train a random forest regressor on DataFrame data.
